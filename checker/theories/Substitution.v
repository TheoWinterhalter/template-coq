...
Proof.
  ...
  rewrite (Forall2_length (All2_Forall2 X0)).
...
Proof.
  ...
  inversion_clear 1.
  rewrite subst_context_snoc. constructor.
  - apply All2_Forall2, Forall2_length in X0. destruct X0.
    apply (subst_eq_decl _ s (#|indctx| + k)) in H.
    unfold subst_decl, map_decl in H; cbn in H.
